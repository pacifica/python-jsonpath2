...
class CurrentNode(Node):
    ...
    def match(self, root_value:object, current_value:object) -> Generator[MatchData, None, None]:
        return map(lambda next_node_match_data: MatchData(CurrentNode(next_node_match_data.node), next_node_match_data.root_value, next_node_match_data.current_value), self.next_node.match(root_value, current_value))
