...
from jsonpath2.subscripts.callable import (
...
class TestNode(TestCase):
    ...
    def setUp(self):
        ...
        self._state = [
            ...
            },
            {
                ...
                "match_data_list": [
                    MatchData(
                        SubscriptNode(TerminalNode(), [ObjectIndexSubscript("hello")]),
                        root_value,
                        root_value["hello"],
                    ),
                    MatchData(
                        SubscriptNode(
                            TerminalNode(), [ObjectIndexSubscript("languages")]
                        ),
                        root_value,
                    ...
                    MatchData(
                        SubscriptNode(
                            TerminalNode(), [ObjectIndexSubscript("preferences")]
                        ),
                        root_value,
            ...
            },
            {
                ...
                "match_data_list": [
                    ...
                    MatchData(
                        SubscriptNode(
                            SubscriptNode(TerminalNode(), [ArrayIndexSubscript(1)]),
                            [ObjectIndexSubscript("languages")],
                        ),
                        root_value,
            ...
            },
            {
                ...
                "node": SubscriptNode(
                    TerminalNode(),
                    [ObjectIndexSubscript("hello"), ObjectIndexSubscript("languages")],
                ),
                "root_value": root_value,
                "current_value": root_value,
                "match_data_list": [
            ...
            },
            {
                ...
                "match_data_list": [
                    ...
                    MatchData(
                        SubscriptNode(
                            SubscriptNode(
                                TerminalNode(), [ObjectIndexSubscript("coffee")]
                            ),
                    ...
                    MatchData(
                        SubscriptNode(
                            SubscriptNode(
                                TerminalNode(), [ObjectIndexSubscript("tea")]
                            ),
                            [ObjectIndexSubscript("preferences")],
                        ),
                        root_value,
            ...
            },
            {
                ...
                # pylint: disable=line-too-long
                "node": SubscriptNode(
                    SubscriptNode(TerminalNode(), [CharAtCallableSubscript(0)]),
                    [ObjectIndexSubscript("hello")],
                ),  # noqa: E501
                # pylint: enable=line-too-long
                "root_value": root_value,
                    ...
                    MatchData(
                        SubscriptNode(
                            SubscriptNode(
                                ...
                                [
                                    CharAtCallableSubscript(
                                        MatchData(TerminalNode(), root_value, 0)
                                    )
                                ],
                            ),
                            [ObjectIndexSubscript("hello")],
            ...
            },
            {
                ...
                # pylint: disable=line-too-long
                "node": SubscriptNode(
                    SubscriptNode(TerminalNode(), [CharAtCallableSubscript(1000)]),
                    [ObjectIndexSubscript("hello")],
                ),  # noqa: E501
                # pylint: enable=line-too-long
                "root_value": root_value,
                        ...
                        [
                            CharAtCallableSubscript(
                                RootNode(
                                    SubscriptNode(
                                        SubscriptNode(
                                            TerminalNode(), [LengthCallableSubscript()]
                                        ),
                                        [ObjectIndexSubscript("hello")],
                                    )
                                )
            ...
            },
            {
                ...
                # pylint: disable=line-too-long
                "node": SubscriptNode(
                    SubscriptNode(TerminalNode(), [SubstringCallableSubscript(1)]),
                    [ObjectIndexSubscript("hello")],
                ),  # noqa: E501
                # pylint: enable=line-too-long
                "root_value": root_value,
                    ...
                    MatchData(
                        SubscriptNode(
                            SubscriptNode(
                                ...
                                [
                                    SubstringCallableSubscript(
                                        MatchData(TerminalNode(), root_value, 1)
                                    )
                                ],
                            ),
                            [ObjectIndexSubscript("hello")],
            ...
            },
            {
                ...
                # pylint: disable=line-too-long
                "node": SubscriptNode(
                    SubscriptNode(TerminalNode(), [SubstringCallableSubscript(1, 3)]),
                    [ObjectIndexSubscript("hello")],
                ),  # noqa: E501
                # pylint: enable=line-too-long
                "root_value": root_value,
            ...
            },
            {
                ...
                # pylint: disable=line-too-long
                "node": SubscriptNode(
                    SubscriptNode(TerminalNode(), [EntriesCallableSubscript()]),
                    [ObjectIndexSubscript("languages")],
                ),  # noqa: E501
                # pylint: enable=line-too-long
                "root_value": root_value,
    ...
    def _assert_node_test_case(self, **kwargs):
        ...
        if isinstance(kwargs["node"], RootNode):
            self.assertEqual(
                kwargs["node"], Path.parse_str(kwargs["__jsonpath__"]).root_node
            )
            ...
            with NamedTemporaryFile() as temp_file:
                ...
                self.assertEqual(
                    kwargs["node"], Path.parse_file(temp_file.name).root_node
                )
        ...
        match_data_list = list(
            kwargs["node"].match(kwargs["root_value"], kwargs["current_value"])
        )
        ...
        for match_data in match_data_list:
            new_match_data_list = list(
                match_data.node.match(kwargs["root_value"], kwargs["current_value"])
            )

            self.assertListEqual([match_data], new_match_data_list)
            self.assertListEqual(
                list(
                    map(lambda match_data: match_data.node.tojsonpath(), [match_data])
                ),
                list(
                    map(
                        lambda match_data: match_data.node.tojsonpath(),
    ...
    def test_parse_callable_subscript(self):
        ...
        with self.assertRaisesRegex(
            ValueError, r"^" + escape("callable subscript 'foo' not found") + r"$"
        ):
